...
const STORAGE_KEY = "SolidShield _cookie_consent";
...
const CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "Help us understand how visitors interact with SolidShield  by collecting and reporting usage data anonymously. No personally identifiable information is stored.",
...
function generateConsentId() {
  return "SolidShield -" + Math.random().toString(36).slice(2, 10).toUpperCase();
}
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  Cookie preferences — SolidShield 
                </h2>
                <p
                  style={{
                    fontSize: "13px",
